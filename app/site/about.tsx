...
const AboutMe: React.FC = () => {
  return (
    <section id="about" className="py-16 px-4 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-300">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center text-center md:text-left">
        ...
        <div className="md:w-2/3 md:ml-8">
          ...
          <p className="text-lg leading-relaxed mb-6">
            Desenvolvi esse porfólio para a matéria de P.I que estou cursando na faculdade, nele vou listar algumas das tarefas que realizei até aqui
          </p>
        </div>
      </div>
    </section>
